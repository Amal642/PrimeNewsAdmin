...
public class AddSevanamActivtiy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_sevanam_activtiy);

        addbus=findViewById(R.id.taxiadd);
        uploadbus=findViewById(R.id.uploadtaxi);
        databaseReference = db.getReference("Sevanam");
    ...
    private void uploadBus() {
        ...
        if(!TextUtils.isEmpty(Addbus)){
            ...
            Intent i = new Intent(AddSevanamActivtiy.this,MainActivity.class);
            startActivity(i);
