...
public class AddSevanamFullActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_sevanam_full);
        ...
        databaseReference=db.getInstance().getReference("Sevanam");
        dataa=db.getInstance().getReference("Sevanams");
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    public void onClick(View view) {
                        ...
                        dataa.child(data).child(id).setValue(busStatDetails1).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(AddSevanamFullActivity.this, "Upload Successful", Toast.LENGTH_SHORT).show();
                                Intent i = new Intent(AddSevanamFullActivity.this, MainActivity.class);
                                startActivity(i);
                ...
                adapter = new ArrayAdapter<String>(AddSevanamFullActivity.this,
