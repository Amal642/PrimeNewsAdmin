...
public class AddThorilaliActvity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_thorilali_actvity);

        addbus=findViewById(R.id.taxiadd);
        uploadbus=findViewById(R.id.uploadtaxi);
        databaseReference = db.getReference("Torilalis");
    ...
    private void uploadBus() {
        ...
        if(!TextUtils.isEmpty(Addbus)){
            ...
            Intent i = new Intent(AddThorilaliActvity.this,MainActivity.class);
            startActivity(i);
