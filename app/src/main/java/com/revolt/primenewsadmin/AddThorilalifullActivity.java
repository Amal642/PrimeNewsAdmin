...
public class AddThorilalifullActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_thorilalifull);
        ...
        databaseReference=db.getInstance().getReference("Torilalis");
        dataa=db.getInstance().getReference("Torilaliss");
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                uploadbtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dataa.child(data).child(id).setValue(busStatDetails1).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(AddThorilalifullActivity.this, "Upload Successful", Toast.LENGTH_SHORT).show();
                                Intent i = new Intent(AddThorilalifullActivity.this, MainActivity.class);
                                startActivity(i);
                ...
                adapter = new ArrayAdapter<String>(AddThorilalifullActivity.this,
