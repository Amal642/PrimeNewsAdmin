...
public class AddBloodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = db.getReference("Blood_upload");
    ...
    private void uploadblood() {
        ...
        if(!TextUtils.isEmpty(name)){
            Blood announcements = new Blood(name,place,num,id);
            databaseReference.child(id).setValue(announcements);
            Toast.makeText(this, "Upload Successful", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(AddBloodActivity.this,MainActivity.class);
