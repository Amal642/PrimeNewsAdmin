...
public class AddOfficeActivity extends AppCompatActivity {
    ...
    private EditText nameEditText,phone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("Office_uploads");
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(AddOfficeActivity.this, "An Upload is Still in Progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
                }
            }
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Office upload = new Office(nameEditText.getText().toString().trim(),
                                            uri.toString(),
                                            descriptionEditText.getText().toString(),phone.getText().toString());
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            // uploadProgressBar.setVisibility(View.INVISIBLE);
                            Toast.makeText(AddOfficeActivity.this,"Failed", Toast.LENGTH_SHORT).show();
                        }
                    });
