...
public class AddShopsFullActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_shops_full);
        ...
        databaseReference=db.getInstance().getReference("shop");
        dataa=db.getInstance().getReference("shops");
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    public void onClick(View view) {
                        ...
                        dataa.child(data).child(id).setValue(busStatDetails1).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(AddShopsFullActivity.this, "Upload Successful", Toast.LENGTH_SHORT).show();
                                Intent i = new Intent(AddShopsFullActivity.this, MainActivity.class);
                                startActivity(i);
                ...
                adapter = new ArrayAdapter<String>(AddShopsFullActivity.this,
